...
class cdefault {
	...
	function Page_Main() {
		...
		$this->Page_Terminate("karyawanlist.php"); // Exit and go to default page
		if ($Security->AllowList(CurrentProjectID() . 'ticket_support'))
			$this->Page_Terminate("ticket_supportlist.php");
		...
		if ($Security->AllowList(CurrentProjectID() . 'monitor.php'))
			$this->Page_Terminate("monitor.php");

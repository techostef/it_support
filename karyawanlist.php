...
class ckaryawan_list extends ckaryawan {
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->id_user_level->AdvancedSearch->ToJson(), ","); // Field id_user_level
		if ($this->BasicSearch->Keyword <> "") {
	...
	function RestoreFilterList() {
		...
		// Field id_user_level
		$this->id_user_level->AdvancedSearch->SearchValue = @$filter["x_id_user_level"];
		$this->id_user_level->AdvancedSearch->SearchOperator = @$filter["z_id_user_level"];
		$this->id_user_level->AdvancedSearch->SearchCondition = @$filter["v_id_user_level"];
		$this->id_user_level->AdvancedSearch->SearchValue2 = @$filter["y_id_user_level"];
		$this->id_user_level->AdvancedSearch->SearchOperator2 = @$filter["w_id_user_level"];
		$this->id_user_level->AdvancedSearch->Save();
	...
	function SetupSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->id_user_level); // id_user_level
...
fkaryawanlist.Lists["x_id_user_level"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"userlevels"};
fkaryawanlist.Lists["x_id_user_level"].Data = "<?php echo $karyawan_list->id_user_level->LookupFilterQuery(FALSE, "list") ?>";
...
<?php if ($karyawan->username->Visible) { // username ?>
	<?php if ($karyawan->SortUrl($karyawan->username) == "") { ?>
		<th data-name="username" class="<?php echo $karyawan->username->HeaderCellClass() ?>"><div id="elh_karyawan_username" class="karyawan_username"><div class="ewTableHeaderCaption"><?php echo $karyawan->username->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="username" class="<?php echo $karyawan->username->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $karyawan->SortUrl($karyawan->username) ?>',1);"><div id="elh_karyawan_username" class="karyawan_username">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $karyawan->username->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($karyawan->username->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($karyawan->username->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($karyawan->no_telp->Visible) { // no_telp ?>
	<?php if ($karyawan->SortUrl($karyawan->no_telp) == "") { ?>
		<th data-name="no_telp" class="<?php echo $karyawan->no_telp->HeaderCellClass() ?>"><div id="elh_karyawan_no_telp" class="karyawan_no_telp"><div class="ewTableHeaderCaption"><?php echo $karyawan->no_telp->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="no_telp" class="<?php echo $karyawan->no_telp->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $karyawan->SortUrl($karyawan->no_telp) ?>',1);"><div id="elh_karyawan_no_telp" class="karyawan_no_telp">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $karyawan->no_telp->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($karyawan->no_telp->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($karyawan->no_telp->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($karyawan->id_user_level->Visible) { // id_user_level ?>
	<?php if ($karyawan->SortUrl($karyawan->id_user_level) == "") { ?>
		<th data-name="id_user_level" class="<?php echo $karyawan->id_user_level->HeaderCellClass() ?>"><div id="elh_karyawan_id_user_level" class="karyawan_id_user_level"><div class="ewTableHeaderCaption"><?php echo $karyawan->id_user_level->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id_user_level" class="<?php echo $karyawan->id_user_level->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $karyawan->SortUrl($karyawan->id_user_level) ?>',1);"><div id="elh_karyawan_id_user_level" class="karyawan_id_user_level">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $karyawan->id_user_level->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($karyawan->id_user_level->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($karyawan->id_user_level->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span id="el<?php echo $karyawan_list->RowCnt ?>_karyawan_username" class="karyawan_username">
...
<span id="el<?php echo $karyawan_list->RowCnt ?>_karyawan_no_telp" class="karyawan_no_telp">
...
<span id="el<?php echo $karyawan_list->RowCnt ?>_karyawan_id_user_level" class="karyawan_id_user_level">

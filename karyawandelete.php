...
fkaryawandelete.Lists["x_id_user_level"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"userlevels"};
fkaryawandelete.Lists["x_id_user_level"].Data = "<?php echo $karyawan_delete->id_user_level->LookupFilterQuery(FALSE, "delete") ?>";
...
<?php if ($karyawan->username->Visible) { // username ?>
		<th class="<?php echo $karyawan->username->HeaderCellClass() ?>"><span id="elh_karyawan_username" class="karyawan_username"><?php echo $karyawan->username->FldCaption() ?></span></th>
<?php } ?>
<?php if ($karyawan->no_telp->Visible) { // no_telp ?>
		<th class="<?php echo $karyawan->no_telp->HeaderCellClass() ?>"><span id="elh_karyawan_no_telp" class="karyawan_no_telp"><?php echo $karyawan->no_telp->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($karyawan->id_user_level->Visible) { // id_user_level ?>
		<th class="<?php echo $karyawan->id_user_level->HeaderCellClass() ?>"><span id="elh_karyawan_id_user_level" class="karyawan_id_user_level"><?php echo $karyawan->id_user_level->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($karyawan->username->Visible) { // username ?>
		<td<?php echo $karyawan->username->CellAttributes() ?>>
<span id="el<?php echo $karyawan_delete->RowCnt ?>_karyawan_username" class="karyawan_username">
<span<?php echo $karyawan->username->ViewAttributes() ?>>
<?php echo $karyawan->username->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($karyawan->no_telp->Visible) { // no_telp ?>
		<td<?php echo $karyawan->no_telp->CellAttributes() ?>>
<span id="el<?php echo $karyawan_delete->RowCnt ?>_karyawan_no_telp" class="karyawan_no_telp">
<span<?php echo $karyawan->no_telp->ViewAttributes() ?>>
<?php echo $karyawan->no_telp->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($karyawan->alamat->Visible) { // alamat ?>
...
<?php } ?>
<?php if ($karyawan->id_user_level->Visible) { // id_user_level ?>
		<td<?php echo $karyawan->id_user_level->CellAttributes() ?>>
<span id="el<?php echo $karyawan_delete->RowCnt ?>_karyawan_id_user_level" class="karyawan_id_user_level">
<span<?php echo $karyawan->id_user_level->ViewAttributes() ?>>
<?php echo $karyawan->id_user_level->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>

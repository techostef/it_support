...
define("EW_PROJECT_NAME", "it_support", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{2D23B2F1-9107-4245-BBC7-F6E2C1DB634A}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'HC03Lexi5UUmZsHc', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/it_support.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "it_support", "qs" => "`", "qe" => "`");
...
define("EW_ADMIN_PASSWORD", "adminoky123", TRUE); // Administrator password
...
define("EW_USER_TABLE", "`karyawan`", TRUE);
